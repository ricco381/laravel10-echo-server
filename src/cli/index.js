...
var yargs = require('yargs')
    ...
    .command(["configure", "init"], "Creates a custom config file.", function (yargs) { return cli.configure(yargs); }) // Has an alias of "init" for backwards compatibility, remove in next version
